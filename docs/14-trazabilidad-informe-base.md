...
| 2 | Convergencia Blockchain + IA + IPFS como respuesta (§1) | TRANSFORMADO | `01-arquitectura.md:3`, `06-validacion-clinica.md:3`, `05-almacenamiento-y-cifrado.md:7` | De las tres patas queda blockchain (L2 público); la IA pasa a motor de reglas y IPFS a opción no elegida |
...
| 14 | Blockchain de consorcio tipo SPChain (§2.1) | CORREGIDO | `01-arquitectura.md:3` y `01:16`; `00:99`, `10:30` | Decisión revertida a L2 público con motivo (no hay comité ni gobernanza en 72 horas); SPChain se menciona solo por trazabilidad histórica |
...
| 16 | Consorcio superior por eficiencia frente a PoW (§2.1) | DESCARTADO | `01-arquitectura.md:15-21` | El argumento de eficiencia se sustituye por tooling, coste y verificabilidad pública de un L2 |
...
| 34 | Solo el CID se registra en Ethereum (§3.2) | TRANSFORMADO | `05-almacenamiento-y-cifrado.md:50-55`; `04:57`, `03:86-91` | On-chain van `contentHash`, `patientCommitment`, prescriptor y dos marcas de tiempo; sobre un L2, no en L1 |
