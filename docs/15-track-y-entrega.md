...
| **Repositorio GitHub** | README con funcionalidades, pasos de instalación, cómo ejecutarlo y **enfoque de integración técnica** | **Parcial.** La instalación y la ejecución ya están: el `README.md` de la raíz tiene *Quick start*, *Requirements*, los dos modos de ejecución, puertos, contratos, scripts del workspace, la CLI de demo, el despliegue vivo en Fuji y la distribución del repositorio. Lo que falta es otra cosa: una **lista explícita de funcionalidades**, una sección de **integración técnica** nombrada como tal, y un enlace a `docs/` presentado como la documentación técnica del proyecto |
...
- [x] Contrato desplegado y verificado, con dirección anotada en el README — `PrescriptionRegistry` en `0xD5F2d5aD03703a9Ee11078d86181421E2E078365`, Avalanche Fuji, código fuente verificado y sección *Live deployment* en el README de la raíz
...
>
> **Recomendación.** (b), condicionada a confirmar que el bounty existe en esta edición, y con (c) como justificación de relevancia. No cuesta trabajo adicional: el contrato está en Avalanche porque ahí corre el proyecto. El requisito de **verificación** del código fuente en el explorador, que era la pieza con riesgo, ya no lo es: el 13/09/2026 el contrato se desplegó en Avalanche Fuji y se verificó en Routescan, y Snowtrace sirve el mismo código porque hoy funciona sobre Routescan (ver [19](19-despliegue.md)). Las dos condiciones que el bounty pide sobre el proyecto —contrato desplegado y verificado en Avalanche— están cumplidas. Lo único que sigue sin confirmarse es que el bounty exista en esta edición.
>
